		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					...
					<h2 class="heading-section">Registra tus datos para la reserva de tu entrada</h2>
					<br>
                              ...
                              <!-- <form action="<?php echo base_url(); ?>index.php/usuario_per/agregarUsu" class="formulario" id="formulario"> -->
                                  ...
                                  <div class="card-body"  >
                                     ...
                                     <?php
                                            ...
                                            echo form_open_multipart('venta/registrarReserva')
                                         ?>
...
<br>
                                            ...
                                            <div justify-conten="center">
                                                ...
                                                <span class="fas fa-clipboard-check"> REGISTRAR RESERVA</span>
