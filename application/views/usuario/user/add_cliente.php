            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form action="<?php echo base_url();?>index.php/cliente/guardar2" method="POST" class="formulario" id="quickForm">
                            ...
                            <div class="form-group <?php echo form_error("numero") != false ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="ci" name="ci" required placeholder="Ingrese C.I." minlength="4"  maxlength="12"  >
