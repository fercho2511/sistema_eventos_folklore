            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form action="<?php echo base_url();?>index.php/usuario_per/addUsuario" method="POST" class="formulario" id="quickForm">
                            ...
                            <div class="form-group <?php echo form_error("nombre") != false ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="apellidos" name="apellido1" required placeholder="Ingrese Apellido" minlength="3"  maxlength="30"    pattern='[A-Za-z]{3,25}' >
                                <!-- <?php echo form_error("nombre","<span class='help-block'>","</span>");?> -->
                            </div>
                            <div class="form-group <?php echo form_error("nombre") != false ? 'has-error':'';?>">
                                <label for="nombre">Apellido Materno:</label>
                                <input type="text" class="form-control" id="apellidos" name="apellido2" required placeholder="Ingrese Apellido" minlength="3"  maxlength="30"    pattern='[A-Za-z]{3,25}' >
                                <!-- <?php echo form_error("nombre","<span class='help-block'>","</span>");?> -->
                            </div>
